...
let imagePath = require("../assets/perfume2.png");
const HomeScreen = () => {
  return (
    <>
        ...
        <SafeAreaView style={styles.style2}>
          ...
          <View style={styles.style3}>
            ...
            <View style={styles.style5}>
              ...
              <Text style={{ fontSize: 14 }}>초본/목본: 초본</Text>
              <Text style={{ fontSize: 14 }}>사진의 장소: 성산 [평지]</Text>
              ...
              <Text style={{ fontSize: 14 }}>피는 시기: 6월</Text>
              <Text style={{ fontSize: 14 }}>
                효능: 항염증, 면역증진, 항산화
              </Text>
            </View>
